> Historische pre-V4.2 bron uit [`db9806f`](https://github.com/nxttrack/platform/tree/db9806f1d12aee7082f5c2848a271ac526e65aa6). Eerdere resultaten zijn geen bewijs voor deze branch; zie het [reconciliation-rapport](../../MAIN-RECONCILIATION-REPORT.md). Verwijzingen naar `docs/codex-input` en `docs/evidence` zijn in die immutable bron bewaard.
