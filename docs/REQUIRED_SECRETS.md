...
| Payment batches | None for preview/approval/stubbed processing; `MOLLIE_API_KEY`, `MOLLIE_WEBHOOK_SECRET`, `MOLLIE_PROFILE_ID` only when provider execution is activated |
