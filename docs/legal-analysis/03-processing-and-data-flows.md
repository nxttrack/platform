...
| Automation builder: regels configureren | Tenantadmin; regels | Event/action, message/config, creator | Tenantadmin | Supabase | Geen algemene executor aangetroffen | Archive-status; geen termijn | RLS/FORCE. `PLANNED/CONFLICT` `[E040]` | UI mag uitvoering niet impliceren; doeleinden/actions |
