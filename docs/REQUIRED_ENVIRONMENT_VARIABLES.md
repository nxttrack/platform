...
| `ALLOW_JOURNEY_BOT_IN_PRODUCTION` | Expliciete noodrem voor productie | Environment guard | Nu | `false` | GitHub environment variable | Blijft voor productie `false`; zonder expliciete override is iedere run geblokkeerd. |
