...
De automation-recipe runner, participant-media expiry en wekelijkse managementconcepten hergebruiken bewust hetzelfde interne `CRON_SECRET`; er is geen extra secret nodig. Tenantrecipes hebben daarnaast een database-afgedwongen `review_only`-grens en kunnen geen externe delivery activeren. Managementconcepten worden alleen als intern concept opgeslagen en nooit automatisch bezorgd.
