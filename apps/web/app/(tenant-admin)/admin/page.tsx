...
export default async function AdminHomePage() {
  const [domain, placement, payments, phase12, afzwem, automation] = await Promise.all([getAdminDomainSnapshot(), getPlacementWorkflowSnapshot(), getAdminPaymentsSnapshot(), getAdminPhase12Snapshot(), getAdminAfzwemSnapshot(), getAdminAutomationSnapshot()]);

  return <AdminOperationsDashboardPage afzwem={afzwem} automation={automation} domain={domain} payments={payments} phase12={phase12} placement={placement} />;
}
