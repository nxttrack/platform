...
export default async function PlatformBadgeAnalyticsPage() {
  ...
  return <div className="space-y-6">
    <PageHeader kicker="Badge Studio" title="Platformanalytics" subtitle="Geaggregeerde productinzichten. Testevents blijven herkenbaar en staan los van echte tenantcijfers." />
