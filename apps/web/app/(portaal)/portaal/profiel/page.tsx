...
import { updateParentMakeupPreferencesAction, updateParentProfileAction } from "@/lib/domain/parent-portal-actions";
...
export default async function ParentProfilePage({ searchParams }: PageProps) {
  ...
  const saved = savedValue === "1" || savedValue === "makeup-preferences";
