...
import { DIPLOMA_VAULT_BUCKET, TENANT_DOCUMENTS_BUCKET } from "./private-files";

export const tenantPrivateBuckets = [TENANT_DOCUMENTS_BUCKET, DIPLOMA_VAULT_BUCKET] as const;
