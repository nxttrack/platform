...
const publicCopies: Record<SupportedLanguage, TenantPublicCopy> = {
  nl: {
    ...
    labels: {
      ...
      recommendedLessonTimesSub: "Kies hieronder maximaal twee voorkeursmomenten uit de beschikbare opties op basis van jouw voorkeuren in het inschrijfformulier.",
      recommendedStage: "Niveau-inschatting",
  ...
  en: {
    ...
    labels: {
      ...
      recommendedLessonTimesSub: "Choose up to two preferred moments below from the available options based on the preferences in your registration form.",
      recommendedStage: "Stage estimate",
