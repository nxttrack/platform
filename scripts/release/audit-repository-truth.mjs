...
checkFile("scripts/staging/prepare-sprint4-isolation.mjs");
...
requireText(deployWorkflow, "sprint4:prepare-admin", "Deploy workflow does not prepare bounded Sprint 4 admin fixtures.");
requireText(deployWorkflow, "sprint4:test-admin", "Deploy workflow does not run the browser-driven Sprint 4 admin journey.");
requireText(deployWorkflow, "sprint4:prepare-isolation", "Deploy workflow does not prepare bounded Sprint 4 isolation fixtures.");
requireText(deployWorkflow, "sprint4:test-isolation", "Deploy workflow does not run the browser-driven Sprint 4 role and tenant isolation checks.");
