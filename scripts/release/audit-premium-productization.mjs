...
check("apps/web/tests/e2e/mollie-sandbox.spec.ts", ["requestSubmit()", "completeMollieTestCheckout", "Veilig betalen via Mollie"]);
check("scripts/staging/verify-mollie-sandbox.mjs", ["repeatedWebhookCount: 2", "providerEventCount", "billingEventCount", "exactly one business effect"]);
