...
const steps = [
  ...
  ["corepack", ["pnpm", "run", "rls:test"], "role isolation contract tests"],
  ["corepack", ["pnpm", "run", "e2e:critical"], "critical workflow E2E contracts"],
  ["corepack", ["pnpm", "run", "e2e:smoke"], "quality-bar workflow smoke tests"],
  ["corepack", ["pnpm", "run", "ui:audit"], "accessibility/responsive/Lovable QA"],
  ["corepack", ["pnpm", "run", "ui:lovable"], "Lovable visual comparison"],
